...
//import com.example.course_add_and_drop_manager_app.presentation.components.FileUtil
...
//    var profile_photo = mutableStateOf<Uri?>(null)  // Modified to store image URI
//
...
//            role = role.value,
//            email = email.value,
//            profile_photo = profile_photo.value?.toString() // Temporarily store URI as string
//        )
//    }
//
//
...
//        }
//
//        // Optional: Convert image URI to Multipart if backend supports image upload
//        fun getProfilePhotoMultipart(context: Context): MultipartBody.Part? {
//            val uri = profile_photo.value ?: return null
//            val file = FileUtil.from(context, uri)
//            val requestFile = file.asRequestBody("image/*".toMediaTypeOrNull())
//            return MultipartBody.Part.createFormData("profile_photo", file.name, requestFile)
//        }
//    }
//
//    fun resetForm() {
